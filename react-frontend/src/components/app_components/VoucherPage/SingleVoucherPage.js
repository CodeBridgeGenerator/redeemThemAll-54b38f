...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Total</label><p className="m-0" ><i id="total" className={`pi ${_entity?.total?"pi-check": "pi-times"}`}  ></i></p></div>
