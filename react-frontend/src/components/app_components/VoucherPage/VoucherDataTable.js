...
const p_booleanTemplate1 = (rowData, { rowIndex }) => <p >{String(rowData.total)}</p>
...
<Column field="total" header="Total" body={p_booleanTemplate1} filter={selectedFilterFields.includes("total")} hidden={selectedHideFields?.includes("total")}  style={{ minWidth: "8rem" }} />
